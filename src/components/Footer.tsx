...
const Footer = () => (
  <footer className="bg-fashion-navy text-secondary mt-16 overflow-x-hidden">
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-0">
            <input
              ...
              className="min-w-0 flex-1 px-3 py-2 text-sm bg-background/10 border border-background/20 rounded-md sm:rounded-l-md sm:rounded-r-none text-background placeholder:text-background/50 outline-none font-body"
            />
            <button className="w-full sm:w-auto px-4 py-2 bg-primary text-primary-foreground text-sm font-semibold rounded-md sm:rounded-l-none sm:rounded-r-md hover:opacity-90 transition-opacity font-body">
              Join
            </button>
          </div>
          <div className="flex flex-wrap items-center gap-3 mt-4">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b7/MasterCard_Logo.svg/200px-MasterCard_Logo.svg.png" alt="Mastercard" className="h-5 opacity-50 max-w-full" loading="lazy" />
